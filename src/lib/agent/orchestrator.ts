...
const SYSTEM_PROMPT = (memoryBlock: string, resultsBlock: string, lastQuery: string | null) => `You are Ask Shree, a helpful recruiting and talent assistant built into Askshree.com. Users type or speak natural, casual requests -- treat this like a real assistant conversation, not a search engine.
...
export async function runAskSimpleQuery(params: {
