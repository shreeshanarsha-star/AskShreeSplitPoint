...
export const GUEST_TOOLS: GuestTool[] = [
  {
    name: "Prepare ATS CV",
    desc: "ATS match score & format optimization",
    href: "/candidate?tab=atscv",
    badge: "Popular",
  ...
  {
    name: "Meet Shree AI",
    desc: "AI Hiring Partner avatar & guidance",
    href: "/avatar",
    badge: "AI Partner",
  ...
  },
  {
    ...
    desc: "Live candidate milestone tracker",
  ...
  {
    name: "Refer & Earn",
    desc: "Share open jobs & earn platform credits",
    href: "/candidate?tab=referrals",
    badge: "Earn Credits",
  ...
  },
  {
    ...
    desc: "Explore verified careers & positions",
    href: "/jobs",
    badge: "Live Board",
...
const ALL_WAFFLE_TOOLS: ToolItem[] = [
  // TALENT & RECRUITMENT (CORE ATS)
  {
    name: "Recruiter Console (ATS)",
    desc: "Live pipeline board, stage triage & candidate calibration",
    href: "/recruiter",
    category: "talent",
    icon: "briefcase",
    badge: "ATS Console",
  ...
  {
    name: "Candidate Pre-Screening Room",
    desc: "Interactive voice & text AI prescreening with STAR rubrics",
    href: "/candidate/prescreen",
    category: "talent",
    icon: "sparkle",
    badge: "AI Screener",
  ...
  {
    name: "Public Careers & Job Board",
    desc: "Explore verified careers, requisition search & instant apply",
    href: "/jobs",
    category: "talent",
    icon: "megaphone",
  ...
  {
    name: "Candidate Status Tracker",
    desc: "Live milestone tracking & calibration transparency",
    href: "/candidate/status",
    category: "talent",
    icon: "chart",
  ...
  {
    name: "Meet Shree AI Partner",
    desc: "AI hiring partner avatar, zero-ghosting ethics & career consult",
    href: "/avatar",
    category: "talent",
    icon: "award",
    badge: "AI Partner",
  ...
  {
    name: "Team Chat",
    desc: "Organizational channels & real-time team collaboration",
    href: "/chat",
    category: "enterprise",
    icon: "chat",
