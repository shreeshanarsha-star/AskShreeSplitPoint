...
const ALL_WAFFLE_TOOLS: ToolItem[] = [
  ...
  // TALENT & RECRUITMENT
  {
    ...
    desc: "Candidate AI front door & voice avatar",
    href: "/",
    category: "talent",
    icon: "sparkle",
    badge: "AI Worker",
  ...
  },
  {
    ...
    desc: "Shadow Mode queue & sourcing triage",
    href: "/recruiter",
    category: "talent",
    icon: "briefcase",
    badge: "Console",
  ...
  {
    name: "Careers Portal",
    desc: "14 live job openings & conversational apply",
    href: "/careers",
    category: "talent",
    icon: "users",
  ...
  },
  {
    ...
    desc: "Real-time application milestone tracker",
