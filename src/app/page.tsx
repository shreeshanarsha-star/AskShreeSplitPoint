        ...
        >
          ...
          >
            ...
            <div className="w-full text-center space-y-2.5">
              ...
              {/* 3 Core Pillars with Premium Rich Icons */}
              <div className="flex flex-wrap items-center justify-center gap-1.5 pt-0.5">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold bg-brand-wash text-brand border border-brand/20">
              ...
              {/* Quick Action CTAs with Rich Vector Icons */}
              ...
              {/* Link to Full Dedicated Avatar Page */}
              <div className="pt-0.5">
                <Link
                  href="/avatar"
                  onClick={() => setShowAvatarModal(false)}
                  className="text-[11px] font-medium text-brand hover:text-brand-dark transition-colors inline-flex items-center gap-1 cursor-pointer"
                >
                  <span>Explore Shree&apos;s Full Profile &amp; Mission</span>
                  <span>&rarr;</span>
                </Link>
              </div>
            </div>
